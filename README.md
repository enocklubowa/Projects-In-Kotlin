...
A list of practical projects solved in Kotlin that anyone else can solve in any programming language. These projects are divided in multiple categories, and each category has its own folder.
